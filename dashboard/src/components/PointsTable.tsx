...
export const PointsTable: React.FC<PointsTableProps> = ({ points, onSelectPointTrend }) => {
  return (
        ...
        <table className="w-full text-left text-sm text-slate-300">
          ...
          <tbody className="divide-y divide-[#1f293d] bg-[#111827]">
            {points.map((pt) => {
              ...
              return (
                <tr key={pt.point_name} className={`hover:bg-slate-800/40 transition ${isAlarm ? 'bg-red-500/5' : ''}`}>
